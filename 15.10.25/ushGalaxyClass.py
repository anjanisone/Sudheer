...
"""Didnt reuse the same processor for Galaxy because name_titles,name_suffixes files are removed for USH, some columns are removed for USH"""

class USHGalaxyDataProcessor:
    def __init__(self, glue_context):
        ...
        self.PREFIX_CONTACTS = "ush_galaxy_cust_contacts"
        self.PREFIX_ADDRESS = "ush_galaxy_addresses"
...
################# transformations #######################
    ...
    def process_and_join_files(self, filepaths: List[str]) -> DataFrame:
        ...
        for base_name, files in file_groups.items():
            ...
            if df is not None:
                ...
                if self.dedupekey in df.columns:
                    ...
                    if prefix != "ush_galaxy_cust_contacts":
        ...
        # Define join mapping
        join_mapping = {
            "ush_galaxy_cust_contacts": "addressid",
            "ush_galaxy_addresses": "addressid"
        }
    ...
    def join_dataframes(self, df_dict, join_mapping):
        # Start with the ush_galaxy_cust_contacts DataFrame as the base
        base_df_name = 'ush_galaxy_cust_contacts'
